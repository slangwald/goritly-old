...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Attributions'
        db.create_table('utils_attributions', (
            ...
            ('u_shape', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('linear', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('first_click', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('last_click', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('decay', self.gf('django.db.models.fields.FloatField')(default=0.0)),
        ))
        db.send_create_signal('utils', ['Attributions'])


    def backwards(self, orm):
        # Deleting model 'Attributions'
        db.delete_table('utils_attributions')
