...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomerCLV.cost_added'
        db.add_column('utils_customerclv', 'cost_added',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.cost_total'
        db.add_column('utils_customerclv', 'cost_total',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CustomerCLV.cost_added'
        db.delete_column('utils_customerclv', 'cost_added')

        # Deleting field 'CustomerCLV.cost_total'
        db.delete_column('utils_customerclv', 'cost_total')
    ...
    models = {
        ...
        'utils.customerclv': {
            ...
            'days_distance': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True'}),
