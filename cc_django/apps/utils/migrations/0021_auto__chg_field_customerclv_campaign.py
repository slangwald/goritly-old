...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomerCLV.campaign'
        db.alter_column('utils_customerclv', 'campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.Partner']))

    def backwards(self, orm):

        # Changing field 'CustomerCLV.campaign'
        db.alter_column('utils_customerclv', 'campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.Campaign']))
    ...
    models = {
        ...
        'utils.customerclv': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['utils.Partner']"}),
            'channel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['utils.Channel']"}),
