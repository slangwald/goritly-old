...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChannelAndCampaignCost.partner'
        db.delete_column('utils_channelandcampaigncost', 'partner_id')


    def backwards(self, orm):
        # Adding field 'ChannelAndCampaignCost.partner'
        db.add_column('utils_channelandcampaigncost', 'partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.Partner'], null=True, blank=True),
                      keep_default=False)
