...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerCLV.revenue_u_shape_total'
        db.add_column('utils_customerclv', 'revenue_u_shape_total',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.revenue_linear_total'
        db.add_column('utils_customerclv', 'revenue_linear_total',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.revenue_first_click_total'
        db.add_column('utils_customerclv', 'revenue_first_click_total',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.revenue_last_click_total'
        db.add_column('utils_customerclv', 'revenue_last_click_total',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.revenue_decay_total'
        db.add_column('utils_customerclv', 'revenue_decay_total',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.revenue_u_shape_added'
        db.add_column('utils_customerclv', 'revenue_u_shape_added',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.revenue_linear_added'
        db.add_column('utils_customerclv', 'revenue_linear_added',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.revenue_first_click_added'
        db.add_column('utils_customerclv', 'revenue_first_click_added',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.revenue_last_click_added'
        db.add_column('utils_customerclv', 'revenue_last_click_added',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.revenue_decay_added'
        db.add_column('utils_customerclv', 'revenue_decay_added',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerCLV.revenue_u_shape_total'
        db.delete_column('utils_customerclv', 'revenue_u_shape_total')

        # Deleting field 'CustomerCLV.revenue_linear_total'
        db.delete_column('utils_customerclv', 'revenue_linear_total')

        # Deleting field 'CustomerCLV.revenue_first_click_total'
        db.delete_column('utils_customerclv', 'revenue_first_click_total')

        # Deleting field 'CustomerCLV.revenue_last_click_total'
        db.delete_column('utils_customerclv', 'revenue_last_click_total')

        # Deleting field 'CustomerCLV.revenue_decay_total'
        db.delete_column('utils_customerclv', 'revenue_decay_total')

        # Deleting field 'CustomerCLV.revenue_u_shape_added'
        db.delete_column('utils_customerclv', 'revenue_u_shape_added')

        # Deleting field 'CustomerCLV.revenue_linear_added'
        db.delete_column('utils_customerclv', 'revenue_linear_added')

        # Deleting field 'CustomerCLV.revenue_first_click_added'
        db.delete_column('utils_customerclv', 'revenue_first_click_added')

        # Deleting field 'CustomerCLV.revenue_last_click_added'
        db.delete_column('utils_customerclv', 'revenue_last_click_added')

        # Deleting field 'CustomerCLV.revenue_decay_added'
        db.delete_column('utils_customerclv', 'revenue_decay_added')
