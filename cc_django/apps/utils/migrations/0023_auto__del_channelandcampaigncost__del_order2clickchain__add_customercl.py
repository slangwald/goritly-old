...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ChannelAndCampaignCost'
        db.delete_table('utils_channelandcampaigncost')

        # Deleting model 'Order2Clickchain'
        db.delete_table('utils_order2clickchain')
    ...
    def backwards(self, orm):
        # Adding model 'ChannelAndCampaignCost'
        db.create_table('utils_channelandcampaigncost', (
        ...
        db.send_create_signal('utils', ['ChannelAndCampaignCost'])

        # Adding model 'Order2Clickchain'
        db.create_table('utils_order2clickchain', (
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.Campaign'], null=True, blank=True)),
        ...
        db.send_create_signal('utils', ['Order2Clickchain'])
