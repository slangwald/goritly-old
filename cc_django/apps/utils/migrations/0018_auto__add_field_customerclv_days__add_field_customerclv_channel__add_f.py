...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerCLV.days'
        db.add_column('utils_customerclv', 'days',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CustomerCLV.channel'
        db.add_column('utils_customerclv', 'channel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['utils.Channel']),
                      keep_default=False)

        # Adding field 'CustomerCLV.campaign'
        db.add_column('utils_customerclv', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['utils.Campaign']),
                      keep_default=False)
        ...
        # Adding field 'CustomerCLV.cost'
        db.add_column('utils_customerclv', 'cost',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'CustomerCLV.roi'
        db.add_column('utils_customerclv', 'roi',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerCLV.days'
        db.delete_column('utils_customerclv', 'days')

        # Deleting field 'CustomerCLV.channel'
        db.delete_column('utils_customerclv', 'channel_id')

        # Deleting field 'CustomerCLV.campaign'
        db.delete_column('utils_customerclv', 'campaign_id')
        ...
        # Deleting field 'CustomerCLV.cost'
        db.delete_column('utils_customerclv', 'cost')

        # Deleting field 'CustomerCLV.roi'
        db.delete_column('utils_customerclv', 'roi')
