...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerCLV.days_distance'
        db.add_column('utils_customerclv', 'days_distance',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerCLV.days_distance'
        db.delete_column('utils_customerclv', 'days_distance')
