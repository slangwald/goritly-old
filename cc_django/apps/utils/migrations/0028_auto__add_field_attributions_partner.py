...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attributions.partner'
        db.add_column('utils_attributions', 'partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['utils.Partner']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attributions.partner'
        db.delete_column('utils_attributions', 'partner_id')
