...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('utils_order', (
            ...
            ('value', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True)),
            ('tax', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True)),
            ('shipping', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('post_code', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
        ...
        db.create_table('utils_orderproducts', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.Order'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.Product'])),
            ('qty', self.gf('django.db.models.fields.FloatField')(default=1)),
            ('price_per_unit', self.gf('django.db.models.fields.FloatField')()),
            ('cost_per_unit', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('utils', ['OrderProducts'])

        # Adding model 'Product'
        db.create_table('utils_product', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('sku', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.ProductCategory'], null=True)),
        ))
        db.send_create_signal('utils', ['Product'])

        # Adding model 'ProductCategory'
        db.create_table('utils_productcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('utils', ['ProductCategory'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('utils_orderproducts')

        # Deleting model 'Product'
        db.delete_table('utils_product')

        # Deleting model 'ProductCategory'
        db.delete_table('utils_productcategory')
