...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Click.position_in_chain'
        db.add_column('utils_click', 'position_in_chain',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Click.position_in_chain'
        db.delete_column('utils_click', 'position_in_chain')
