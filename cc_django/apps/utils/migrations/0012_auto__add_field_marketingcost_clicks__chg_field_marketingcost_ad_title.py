...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarketingCost.clicks'
        db.add_column('utils_marketingcost', 'clicks',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'MarketingCost.ad_title'
        db.alter_column('utils_marketingcost', 'ad_title_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.AdTitle'], null=True))

        # Changing field 'MarketingCost.ad_group'
        db.alter_column('utils_marketingcost', 'ad_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.AdGroup'], null=True))

    def backwards(self, orm):
        # Deleting field 'MarketingCost.clicks'
        db.delete_column('utils_marketingcost', 'clicks')


        # Changing field 'MarketingCost.ad_title'
        db.alter_column('utils_marketingcost', 'ad_title_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['utils.AdTitle']))

        # Changing field 'MarketingCost.ad_group'
        db.alter_column('utils_marketingcost', 'ad_group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['utils.AdGroup']))
