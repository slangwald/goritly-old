...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Click.order'
        db.add_column('utils_click', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.Order'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Click.order'
        db.delete_column('utils_click', 'order_id')
