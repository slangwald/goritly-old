...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MarketingCost.date'
        db.alter_column('utils_marketingcost', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'MarketingCost.date'
        db.alter_column('utils_marketingcost', 'date', self.gf('django.db.models.fields.DateTimeField')())
