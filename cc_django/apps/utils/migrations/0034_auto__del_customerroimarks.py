...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'MarketingCost', fields ['date']
        db.create_index('utils_marketingcost', ['date'])


    def backwards(self, orm):
        # Removing index on 'MarketingCost', fields ['date']
        db.delete_index('utils_marketingcost', ['date'])
