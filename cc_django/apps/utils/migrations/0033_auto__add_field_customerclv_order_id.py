...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerCLV.order_id'
        db.add_column('utils_customerclv', 'order_id',
                      self.gf('django.db.models.fields.CharField')(default='TBD', max_length=255, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerCLV.order_id'
        db.delete_column('utils_customerclv', 'order_id')
