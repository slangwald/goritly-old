...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderProductsReturns'
        db.create_table('utils_orderproductsreturns', (
        ...
        db.send_create_signal('utils', ['OrderProductsReturns'])

        # Adding field 'CustomerCLV.first_ordered_at'
        db.add_column('utils_customerclv', 'first_ordered_at',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 5, 2, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OrderProductsReturns'
        db.delete_table('utils_orderproductsreturns')

        # Deleting field 'CustomerCLV.first_ordered_at'
        db.delete_column('utils_customerclv', 'first_ordered_at')
