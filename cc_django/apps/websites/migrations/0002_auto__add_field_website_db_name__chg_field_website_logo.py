...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Website.db_name'
        db.add_column('websites_website', 'db_name',
                      self.gf('django.db.models.fields.CharField')(default='website_1', max_length=20),
                      keep_default=False)


        # Changing field 'Website.logo'
        db.alter_column('websites_website', 'logo_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['profiles.Image'], null=True))

    def backwards(self, orm):
        # Deleting field 'Website.db_name'
        db.delete_column('websites_website', 'db_name')


        # Changing field 'Website.logo'
        db.alter_column('websites_website', 'logo_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.Image']))
